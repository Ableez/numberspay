  ...
  const testimonials: Testimonial[] = [
    {
      ...
      content:
        "Wow, if I could send supplier payments instantly, globally, without those crazy fees... that would seriously change everything!",
      rating: 5,
    ...
    },
    {
      ...
      role: "Prototype Tester",
      content:
        "Numberspay will make getting paid by international clients feel as simple as sharing my phone number. i think this is going to be a game-changer!",
      rating: 5,
      image: "/placeholder.svg?height=64&width=64",
    },
    {
      ...
      role: "Prototype Tester",
      content:
        "If i could send money, in this very low rate fees high costs are no more!",
      rating: 5,
      image: "/placeholder.svg?height=64&width=64",
    },
  ];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Here's a glimpse into the simple, borderless payment experience
            we're building with Numbers Pay.
          </p>
        </div>
